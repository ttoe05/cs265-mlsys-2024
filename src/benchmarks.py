...
model_batch_sizes: Dict[str, int] = {
    "torchbenchmark.models.hf_Bert.Model": 4,
    "torchbenchmark.models.resnet50.Model": 4,
    "torchbenchmark.models.resnet152.Model": 4,
}
...
class Experiment:
    def __init__(self, model_name: str, batch_size: int, extra_args=[]):
        ...
        model: BenchmarkModel = model_class(
            "train", "mps", batch_size=batch_size, extra_args=extra_args
        )
